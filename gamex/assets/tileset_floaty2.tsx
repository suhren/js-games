...
<tileset version="1.4" tiledversion="1.4.3" name="floaty" tilewidth="16" tileheight="16" tilecount="7" columns="7">
 <image source="images/enemies/floaty2_animation.png" width="112" height="16"/>
 <tile id="6">
  <animation>
